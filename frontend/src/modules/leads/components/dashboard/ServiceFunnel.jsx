const STAGES = [
  ...
  },
  {
    ...
    bar: "bg-[#059669]", // Verde (Avance y positividad)
    dot: "bg-[#059669]",
    text: "text-[#047857]",
    soft: "bg-[#059669]/10",
  },
  {
    ...
    bar: "bg-[#334155]", // Gris Grafito (Formalidad y experiencia premium)
    dot: "bg-[#334155]",
    text: "text-[#1E293B]",
    soft: "bg-[#334155]/10",
  },
  {
    ...
    bar: "bg-[#EB0A1E]", // Rojo Toyota (Acción, cierre y éxito)
    dot: "bg-[#EB0A1E]",
    text: "text-[#B91C1C]",
    soft: "bg-[#EB0A1E]/10",
  },
