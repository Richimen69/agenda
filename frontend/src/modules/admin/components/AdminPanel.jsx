    ...
    try {
      ...
      if (result.success) {
        sileo.success({
          ...
          description: name + " " + "Registrado correctamente",
          fill: "#D8F3DC",
          styles: {
            title: "text-black/75!",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <input
              type="text"
              placeholder="WhatsApp (Ej: 7441234567)"
              required
              value={whats}
            ...
            <button
              ...
              className="w-full py-3 bg-indigo-600 text-white text-sm font-bold rounded-xl hover:bg-indigo-700"
            >
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    {user.email} • WA: {user.whatsappPhone}
                  </p>
                </div>
                <button
